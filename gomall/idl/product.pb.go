...
func (x *DeductStockResp) Reset() {
	*x = DeductStockResp{}
	mi := &file_idl_product_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeductStockResp) Descriptor() ([]byte, []int) {
	return file_idl_product_proto_rawDescGZIP(), []int{14}
}
...
func (x *RestoreStockReq) Reset() {
	*x = RestoreStockReq{}
	mi := &file_idl_product_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RestoreStockReq) Descriptor() ([]byte, []int) {
	return file_idl_product_proto_rawDescGZIP(), []int{15}
}
...
func (x *RestoreStockResp) Reset() {
	*x = RestoreStockResp{}
	mi := &file_idl_product_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RestoreStockResp) Descriptor() ([]byte, []int) {
	return file_idl_product_proto_rawDescGZIP(), []int{16}
}
...
func (x *GetStockReq) Reset() {
	*x = GetStockReq{}
	mi := &file_idl_product_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetStockReq) Descriptor() ([]byte, []int) {
	return file_idl_product_proto_rawDescGZIP(), []int{17}
}
...
func (x *GetStockResp) Reset() {
	*x = GetStockResp{}
	mi := &file_idl_product_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetStockResp) Descriptor() ([]byte, []int) {
	return file_idl_product_proto_rawDescGZIP(), []int{18}
}
...
const file_idl_product_proto_rawDesc = "" +
	"\n" +
	"\x11idl/product.proto\x12\aproduct\"e\n" +
	"\x0fListProductsReq\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x05R\x04page\x12\x1a\n" +
	"\bpageSize\x18\x02 \x01(\x03R\bpageSize\x12\"\n" +
	"\fcategoryName\x18\x03 \x01(\tR\fcategoryName\"\xb5\x01\n" +
	"\aProduct\x12\x0e\n" +
	...
	"categories\x12\x14\n" +
	"\x05sales\x18\a \x01(\rR\x05sales\"@\n" +
	...
	"\x06exists\x18\x02 \x01(\bR\x06exists2\x93\x05\n" +
	...
	"\bGetStock\x12\x14.product.GetStockReq\x1a\x15.product.GetStockResp\"\x00B\n" +
...
var file_idl_product_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
...
var file_idl_product_proto_depIdxs = []int32{
	...
	11, // 8: product.ProductCatalogService.IncrementSales:input_type -> product.IncrementSalesReq
	13, // 9: product.ProductCatalogService.DeductStock:input_type -> product.DeductStockReq
	15, // 10: product.ProductCatalogService.RestoreStock:input_type -> product.RestoreStockReq
	17, // 11: product.ProductCatalogService.GetStock:input_type -> product.GetStockReq
	...
	12, // 17: product.ProductCatalogService.IncrementSales:output_type -> product.IncrementSalesResp
	14, // 18: product.ProductCatalogService.DeductStock:output_type -> product.DeductStockResp
	16, // 19: product.ProductCatalogService.RestoreStock:output_type -> product.RestoreStockResp
	18, // 20: product.ProductCatalogService.GetStock:output_type -> product.GetStockResp
