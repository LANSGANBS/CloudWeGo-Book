...
type Client interface {
	...
	DeductStock(ctx context.Context, Req *product.DeductStockReq, callOptions ...callopt.Option) (r *product.DeductStockResp, err error)
	RestoreStock(ctx context.Context, Req *product.RestoreStockReq, callOptions ...callopt.Option) (r *product.RestoreStockResp, err error)
	GetStock(ctx context.Context, Req *product.GetStockReq, callOptions ...callopt.Option) (r *product.GetStockResp, err error)
}
...
func (p *kProductCatalogServiceClient) IncrementSales(ctx context.Context, Req *product.IncrementSalesReq, callOptions ...callopt.Option) (r *product.IncrementSalesResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.IncrementSales(ctx, Req)
}

func (p *kProductCatalogServiceClient) DeductStock(ctx context.Context, Req *product.DeductStockReq, callOptions ...callopt.Option) (r *product.DeductStockResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeductStock(ctx, Req)
}

func (p *kProductCatalogServiceClient) RestoreStock(ctx context.Context, Req *product.RestoreStockReq, callOptions ...callopt.Option) (r *product.RestoreStockResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.RestoreStock(ctx, Req)
}

func (p *kProductCatalogServiceClient) GetStock(ctx context.Context, Req *product.GetStockReq, callOptions ...callopt.Option) (r *product.GetStockResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
