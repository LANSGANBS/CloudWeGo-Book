...
type RPCClient interface {
	...
	IncrementSales(ctx context.Context, Req *product.IncrementSalesReq, callOptions ...callopt.Option) (r *product.IncrementSalesResp, err error)
}
...
func (c *clientImpl) IncrementSales(ctx context.Context, Req *product.IncrementSalesReq, callOptions ...callopt.Option) (r *product.IncrementSalesResp, err error) {
	return c.kitexClient.IncrementSales(ctx, Req, callOptions...)
}
