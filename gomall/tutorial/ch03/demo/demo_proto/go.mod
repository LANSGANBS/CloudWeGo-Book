...
replace github.com/cloudwego/biz-demo/gomall/demo/demo_thrift => ../demo_thrift

require (
	github.com/cloudwego/biz-demo/gomall/demo/demo_thrift v0.0.0-00010101000000-000000000000
